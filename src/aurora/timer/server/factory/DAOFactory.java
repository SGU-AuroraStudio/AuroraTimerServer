...
public class DAOFactory {
    public static IUserDataDAO getIUserDataDAOInstance(Connection conn) {
        return new UserDataDAOImpl(conn);
    }

    public static IUserOnlineTimeDAO getIUserOnlineTimeDAOInstance(Connection conn) {
        return new UserOnlineTimeDAOImpl(conn);
    }
}
